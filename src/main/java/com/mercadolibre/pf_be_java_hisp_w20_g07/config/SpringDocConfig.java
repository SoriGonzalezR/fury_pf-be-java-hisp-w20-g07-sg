...
import static com.mercadolibre.pf_be_java_hisp_w20_g07.util.ScopeUtils.getScopeValue;
import static com.mercadolibre.pf_be_java_hisp_w20_g07.util.ScopeUtils.isLocalScope;
  ...
  public OpenAPI customOpenAPI(
    ...
    Info info = new Info()
        ...
        .contact(
            new Contact()
                .name("manuel diaz")
                .email("manuel.diaz@mercadolibre.com.co"));
